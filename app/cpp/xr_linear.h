...
inline static void XrVector3f_Lerp(XrVector3f *result,
                                   const XrVector3f *a,
                                   const XrVector3f *b,
...
inline static void XrVector3f_Scale(XrVector3f *result,
                                    const XrVector3f *a,
...
inline static void XrQuaternionf_CreateFromAxisAngle(XrQuaternionf *result,
...
inline static void XrQuaternionf_Lerp(XrQuaternionf *result,
...
inline static void XrQuaternionf_Multiply(XrQuaternionf *result,
                                          const XrQuaternionf *a,
                                          const XrQuaternionf *b) {
...
inline static void XrMatrix4x4f_Multiply(XrMatrix4x4f *result,
...
inline static float XrMatrix4x4f_Minor(const XrMatrix4x4f *matrix,
                                       int r0,
                                       int r1,
                                       int r2,
                                       int c0,
...
inline static void XrMatrix4x4f_CreateTranslation(XrMatrix4x4f *result,
                                                  const float x,
                                                  const float y,
                                                  const float z) {
  result->m[0] = 1.0f;
...
inline static void XrMatrix4x4f_CreateRotation(XrMatrix4x4f *result,
...
inline static void XrMatrix4x4f_CreateScale(XrMatrix4x4f *result,
                                            const float x,
                                            const float y,
                                            const float z) {
  result->m[0] = x;
...
inline static void XrMatrix4x4f_CreateProjection(XrMatrix4x4f *result,
  ...
  const float
      offsetZ = (graphicsApi == GRAPHICS_OPENGL || graphicsApi == GRAPHICS_OPENGL_ES) ? nearZ : 0;
...
inline static void XrMatrix4x4f_CreateProjectionFov(XrMatrix4x4f *result,
  ...
  XrMatrix4x4f_CreateProjection(result,
                                graphicsApi,
                                tanLeft,
                                tanRight,
                                tanUp,
...
inline static void XrMatrix4x4f_CreateOffsetScaleForBounds(XrMatrix4x4f *result,
                                                           const XrMatrix4x4f *matrix,
                                                           const XrVector3f *mins,
                                                           const XrVector3f *maxs) {
  const XrVector3f
      offset = {(maxs->x + mins->x) * 0.5f, (maxs->y + mins->y) * 0.5f, (maxs->z + mins->z) * 0.5f};
  const XrVector3f
      scale = {(maxs->x - mins->x) * 0.5f, (maxs->y - mins->y) * 0.5f, (maxs->z - mins->z) * 0.5f};
...
inline static void XrMatrix4x4f_GetRotation(XrQuaternionf *result, const XrMatrix4x4f *src) {
  ...
  const float
      rcpScaleX = XrRcpSqrt(src->m[0] * src->m[0] + src->m[1] * src->m[1] + src->m[2] * src->m[2]);
  const float
      rcpScaleY = XrRcpSqrt(src->m[4] * src->m[4] + src->m[5] * src->m[5] + src->m[6] * src->m[6]);
  const float rcpScaleZ =
      XrRcpSqrt(src->m[8] * src->m[8] + src->m[9] * src->m[9] + src->m[10] * src->m[10]);
...
inline static void XrMatrix4x4f_TransformVector3f(XrVector3f *result,
                                                  const XrMatrix4x4f *m,
                                                  const XrVector3f *v) {
...
inline static void XrMatrix4x4f_TransformVector4f(XrVector4f *result,
                                                  const XrMatrix4x4f *m,
                                                  const XrVector4f *v) {
...
inline static void XrMatrix4x4f_TransformBounds(XrVector3f *resultMins,
  ...
  const XrVector3f
      center = {(mins->x + maxs->x) * 0.5f, (mins->y + maxs->y) * 0.5f, (mins->z + maxs->z) * 0.5f};
...
inline static bool XrMatrix4x4f_CullBounds(const XrMatrix4x4f *mvp,
                                           const XrVector3f *mins,
                                           const XrVector3f *maxs) {
